...
if __name__ == "__main__":
    library = Library()
    book1 = Book(id_=library.get_next_book_id(), name='Охота на овец', pages=222) #id == 1, ind == 0
    library.books.append(book1)

    book2 = Book(id_=library.get_next_book_id(), name='Норвежский лес', pages=5454) #id == 2, ind == 1
